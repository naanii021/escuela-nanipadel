...
function Torneos() {
  ...
  const filterCounts = useMemo(() => {
    ...
    for (const t of torneos) {
      if (counts[t.categoria] !== undefined) counts[t.categoria]++;
    }
    return counts;
  }, [torneos]);
      ...
      <div className="torneosShell">
        ...
        <div className="torneosHero">
          <div className="torneosHeroText">
            ...
            <p className="intro">
              Compite por categorias, revisa plazas disponibles en tiempo real
              y apunta tu pareja en los eventos activos del club.
            </p>
          </div>
        ...
        {/* ── ERROR ── */}
        {!loading && err && (
          <div className="torneosMessage torneosError" role="alert">{err}</div>
        )}
              ...
              return (
                ...
                >
                  ...
                  <div className="torneoBody">
                    ...
                    {torneo.descripcion && (
                      <p className="torneoDescripcion">{torneo.descripcion}</p>
                    )}
